...
.s-top-right .ai-entry-right{display:inline-block;width:24px;height:24px;line-height:24px;margin-right:-8px;top:-2px;cursor:pointer;position:relative}
.s-top-right .ai-entry-right:hover .ai-entry-bubble{background:rgba(224,236,255,.8)}
.s-top-right .ai-entry-right:hover .ai-entry-bubble .ai-entry-bubble-text{color:#315efb}
.s-top-right .ai-entry-right .ai-entry-mask{position:absolute;width:22px;height:22px;top:1px;right:0;border-radius:0 11px 11px 0;z-index:-1;padding-left:var(--bubble-padding-left);overflow:hidden}
.s-top-right .ai-entry-right .ai-entry-mask .ai-entry-bubble{position:absolute;right:0;top:0;height:21px;line-height:21px;border-radius:12px;padding:0 30px 0 12px;z-index:-2;color:#2932e1;font-size:13px;background:rgba(224,236,255,.7);transform:translateX(var(--bubble-width))}
.s-top-right .ai-entry-right .ai-entry-mask .ai-entry-bubble .ai-entry-bubble-text{opacity:0}
.s-top-right .ai-entry-right .ai-entry-icon{width:24px;height:24px}
.s-top-right .ai-entry-right.ai-icon-show-animation .ai-entry-icon{animation:iconHeart .4s linear}
.s-top-right .ai-entry-right.ai-icon-show-animation .ai-entry-bubble{animation:bubbleSlide .36s .5s ease-in-out forwards}
.s-top-right .ai-entry-right.ai-icon-show-animation .ai-entry-bubble .ai-entry-bubble-text{animation:bubbleText .24s .82s linear forwards}
@keyframes iconHeart{
0%{transform:scale(1)}
...
0%{transform:translateX(var(--bubble-width))}
...
.s-top-right .ai-entry-right.ai-icon-hide-animation .ai-entry-icon{animation:iconHeartHide .4s .24s linear}
.s-top-right .ai-entry-right.ai-icon-hide-animation .ai-entry-bubble{animation:bubbleSlideHide .38s .16s ease-in-out forwards}
.s-top-right .ai-entry-right.ai-icon-hide-animation .ai-entry-bubble .ai-entry-bubble-text{animation:bubbleTextHide .24s linear forwards}
@keyframes iconHeartHide{
0%{transform:scale(1)}
60%{transform:scale(1.1)}
100%{transform:scale(1)}
}
@keyframes bubbleSlideHide{
0%{transform:translateX(0)}
100%{transform:translateX(var(--bubble-width))}
}
@keyframes bubbleTextHide{
0%{opacity:1}
100%{opacity:0}
}
...
.darkmode.blue .mnav.s-top-more-btn .s-bri,.darkmode.blue .s-ctner-menus .current,.darkmode.blue .s-ctner-menus .menus-wrapper,.darkmode.blue .s-hotsearch-wrapper .hot-refresh,.darkmode.blue .s-hotsearch-wrapper .s-hotsearch-title .title-text,.darkmode.blue .s-news-rank-wrapper .s-rank-title .hot-refresh,.darkmode.blue .s-news-rank-wrapper .s-rank-title div,.darkmode.blue .s-news-rank-wrapper .s-rank-title i,.darkmode.blue .s-top-left .mnav,.darkmode.blue .s-top-right .s-top-right-text,.darkmode.blue .s-top-right .s-top-username .s-top-img-wrapper,.darkmode.blue .s-top-right .s-top-username .user-name,.darkmode.blue .s-weather-wrapper .s-mod-weather .unknown-city .unknown-setting,.darkmode.blue .s-weather-wrapper .show-city-name,.darkmode.blue .s-weather-wrapper .show-icon-temp,.darkmode.dark .mnav.s-top-more-btn .s-bri,.darkmode.dark .s-ctner-menus .current,.darkmode.dark .s-ctner-menus .menus-wrapper,.darkmode.dark .s-hotsearch-wrapper .hot-refresh,.darkmode.dark .s-hotsearch-wrapper .s-hotsearch-title .title-text,.darkmode.dark .s-news-rank-wrapper .s-rank-title .hot-refresh,.darkmode.dark .s-news-rank-wrapper .s-rank-title div,.darkmode.dark .s-news-rank-wrapper .s-rank-title i,.darkmode.dark .s-top-left .mnav,.darkmode.dark .s-top-right .s-top-right-text,.darkmode.dark .s-top-right .s-top-username .s-top-img-wrapper,.darkmode.dark .s-top-right .s-top-username .user-name,.darkmode.dark .s-weather-wrapper .s-mod-weather .unknown-city .unknown-setting,.darkmode.dark .s-weather-wrapper .show-city-name,.darkmode.dark .s-weather-wrapper .show-icon-temp{color:#ffd862!important}
.darkmode.blue .mnav.s-top-more-btn .s-bri:hover,.darkmode.blue .s-ctner-menus .current:hover,.darkmode.blue .s-ctner-menus .menus-wrapper:hover,.darkmode.blue .s-ctner-menus .s-menu-item:hover,.darkmode.blue .s-hotsearch-wrapper .hot-refresh:hover,.darkmode.blue .s-hotsearch-wrapper .s-hotsearch-title .title-text:hover,.darkmode.blue .s-news-rank-wrapper .s-rank-title .hot-refresh:hover,.darkmode.blue .s-news-rank-wrapper .s-rank-title div:hover,.darkmode.blue .s-news-rank-wrapper .s-rank-title i:hover,.darkmode.blue .s-top-left .mnav:hover,.darkmode.blue .s-top-right .s-top-right-text:hover,.darkmode.blue .s-top-right .s-top-username .user-name:hover,.darkmode.blue .s-weather-wrapper .s-mod-weather .unknown-city .unknown-setting:hover,.darkmode.blue .s-weather-wrapper .show-city-name:hover,.darkmode.blue .s-weather-wrapper .show-icon-temp:hover,.darkmode.dark .mnav.s-top-more-btn .s-bri:hover,.darkmode.dark .s-ctner-menus .current:hover,.darkmode.dark .s-ctner-menus .menus-wrapper:hover,.darkmode.dark .s-ctner-menus .s-menu-item:hover,.darkmode.dark .s-hotsearch-wrapper .hot-refresh:hover,.darkmode.dark .s-hotsearch-wrapper .s-hotsearch-title .title-text:hover,.darkmode.dark .s-news-rank-wrapper .s-rank-title .hot-refresh:hover,.darkmode.dark .s-news-rank-wrapper .s-rank-title div:hover,.darkmode.dark .s-news-rank-wrapper .s-rank-title i:hover,.darkmode.dark .s-top-left .mnav:hover,.darkmode.dark .s-top-right .s-top-right-text:hover,.darkmode.dark .s-top-right .s-top-username .user-name:hover,.darkmode.dark .s-weather-wrapper .s-mod-weather .unknown-city .unknown-setting:hover,.darkmode.dark .s-weather-wrapper .show-city-name:hover,.darkmode.dark .s-weather-wrapper .show-icon-temp:hover{color:#fff762!important}
.darkmode.blue .s-ctner-menus .s-menu-item-underline,.darkmode.dark .s-ctner-menus .s-menu-item-underline{background:#a8acad}
.darkmode.blue .s-top-right .ai-entry-right .ai-entry-bubble,.darkmode.dark .s-top-right .ai-entry-right .ai-entry-bubble{background:rgba(224,236,255,.15)}
.darkmode.blue .s-top-right .ai-entry-right .ai-entry-bubble .ai-entry-bubble-text,.darkmode.dark .s-top-right .ai-entry-right .ai-entry-bubble .ai-entry-bubble-text{color:#f7d260}
.darkmode.blue .s-top-right .ai-entry-right:hover .ai-entry-bubble,.darkmode.dark .s-top-right .ai-entry-right:hover .ai-entry-bubble{background:rgba(224,236,255,.25)}
.darkmode.blue .s-top-right .ai-entry-right:hover .ai-entry-bubble .ai-entry-bubble-text,.darkmode.dark .s-top-right .ai-entry-right:hover .ai-entry-bubble .ai-entry-bubble-text{color:#fff762}
.darkmode.blue .undertips-ai-entry .undertips-ai-right,.darkmode.dark .undertips-ai-entry .undertips-ai-right{color:#f7d260;background-image:linear-gradient(96deg,rgba(224,244,255,.15) 0,rgba(227,240,255,.15) 63%,rgba(235,229,255,.15) 100%)}
.darkmode.blue .undertips-ai-entry .undertips-ai-right .undertips-ai-button,.darkmode.dark .undertips-ai-entry .undertips-ai-right .undertips-ai-button{background:rgba(255,255,255,.2)}
.darkmode.blue .undertips-ai-entry:hover .undertips-ai-right,.darkmode.dark .undertips-ai-entry:hover .undertips-ai-right{color:#fff762;background-image:linear-gradient(96deg,rgba(224,244,255,.25) 0,rgba(227,240,255,.25) 63%,rgba(235,229,255,.25) 100%)}
.darkmode.blue .undertips-ai-entry:hover .undertips-ai-button,.darkmode.dark .undertips-ai-entry:hover .undertips-ai-button{background:rgba(255,255,255,.3)}
...
.darkmode .s-block-stock .stock-item .stock-highprice,.darkmode .s-block-stock .stock-item .stock-lowprice,.darkmode .s-block-stock .stock-item .stock-updatetime,.darkmode .s-skin-hasbg .s-block-stock .stock-banner,.darkmode .s-xmancard-mine_new .tips-manager-btn .manager-btn-text{color:#a8acad}
...
.sui-draggsort-holder{border:0!important;position:absolute}</style><style type="text/css" index="weather">.s-weather-wrapper{float:none;display:inline-block;margin-left:32px;margin-top:19px;height:23px;vertical-align:top}
...
.desktop-opt{display:none;position:absolute;z-index:3;right:4px;top:-36px;color:#444754;cursor:pointer}
.desktop-opt:hover{color:#315efb}
.desktop-opt:hover i{color:#315efb}
.desktop-opt i{position:relative;top:1px;left:0;margin-right:5px;font-size:16px;color:#9195a3}
...
.s-ctner-menus .s-menu-item:hover{color:#222}
.s-ctner-menus .current,.s-ctner-menus .current:hover{color:#222}
...
#s_side_wrapper{position:fixed;right:24px;bottom:64px;background-color:#fbfbfb;width:44px;border-radius:22px;z-index:3}
...
#s_skin_upload{display:none}</style></textarea><div id="wrapper" class="wrapper_new"><div class='s-skin-container s-isindex-wrap skin-gray-event' style="background-color:; background-image:url(https://dss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/skin_zoom/822.jpg?2)"></div><div id="head" class="s-skin-hasbg white-logo s-opacity-70"><div id="s_top_wrap" class="s-top-wrap s-isindex-wrap "><div class="s-top-nav"></div><div class="s-center-box"></div></div><div id="s-top-left" class="s-top-left-new s-isindex-wrap"><a href="http://news.baidu.com" target="_blank" class="mnav c-font-normal c-color-t">新闻</a><a href="https://www.hao123.com?src=from_pc_logon" target="_blank" class="mnav c-font-normal c-color-t">hao123</a><a href="http://map.baidu.com" target="_blank" class="mnav c-font-normal c-color-t">地图</a><a href="http://tieba.baidu.com/" target="_blank" class="mnav c-font-norm
.com/more/' target='_blank' name='tj_more'>查看全部百度产品 ></a></div></div></div></div><div id="u1" class="s-top-right s-isindex-wrap"><div class="s-weather-wrapper"><div id="s_mod_weather" class="s-mod-weather s-isindex-wrap hide-unknow-city"><div class="weather-mod"><a class="city-wather" href="//www.baidu.com/s?tn=baidutop10&amp;rsv_idx=2&amp;wd=北京天气预报" target="_blank" class="weather-mod-link"><div class="show-weather"><span class="show-city"><span class="show-city-name c-font-normal c-color-t" data-key="4077">昌平</span></span><span class="show-icon"><img class="weather-icon" src="https://dss1.bdstatic.com/5aV1bjqh_Q23odCf/static/superman/img/weather/icons/a0.png"/><span class="show-icon-temp c-font-normal c-color-t">24℃</span></span><span class="show-temp"></span></div></a><div class="show-pollution "><span class="show-airParm polution-level-0"><span class="show-polution-name">优</span></span></div></div><div class="unknown-city"><span class="unknown-icon c-icon">&#xe60f;</span><span class="unknown-setting c-font-normal c-color-t">查看天气信息</span></div></div></div><span class="s-top-right-text c-font-normal c-color-t s-top-right-new" id="s-usersetting-top" name="tj_settingicon">设置</span><a id="s-top-username" class="s-top-username s-top-right-new" data-tid="2004" href="https://www.baidu.com/my/index" target="_blank"><span class="s-top-img-wrapper"><img src="https://himg.bdimg.com/sys/portraitn/item/public.1.1d165301.HC16S9EoS2_4zgTf4zCqzw"/></span><span class="user-name c-font-normal c-color-t">kienth</span></a><div id="s-user-name-menu" class="s-top-userset-menu c-floating-box c-font-normal"><a href="https://www.baidu.com/my/index" class="user-menu-item" target="_blank" data-tid="1000">
            ...
            退出登录
        </a></div><div id="s-user-setting-menu" class="s-top-userset-menu c-floating-box c-font-normal "><div class="s-user-setting-pfmenu"></div><a class="s-set-feed hide-feed" href="javascript:;">隐藏资讯</a><a class="s-set-feed show-feed" href="javascript:;">展示资讯</a><span class="s-set-homepage-tts"><a class="set-open-homepage-tts" href="javascript:;">开启播报</a><a class="set-close-homepage-tts" href="javascript:;">关闭播报</a></span><span class="split-line"></span><a class="s-set-skin" href="javascript:;" data-tid="2001">更换皮肤</a></div><div class="guide-info guide-info-login"><i class="c-icon guide-icon">&#xe625;</i><span>新春焕新肤，设置后即可拥有！</span><i class="c-icon guide-close">&#xe610;</i></div></div><style>
...
</style><div class='clear'></div><div id="head_wrapper" class="s-isindex-wrap head_wrapper s-title-img "><div id="s_fm" class="s_form s_form_login "><div class="s_form_wrapper " id="s_form_wrapper"><div id="lg" class="s-p-top"><img id="s_lg_img" class='s_lg_img_gold_show' src="//www.baidu.com/img/PCfb_5bf082d29588c07f842ccde3f97243ea.png" width="270"  height="129" onerror="this.src='https://pss.bdstatic.com/static/superman/img/logo/logo_white-d0c9fe2af5.png';this.onerror=null;" usemap="#mp" /><img id="s_lg_img_new" class='s_lg_img_gold_showre' src="//www.baidu.com/img/PCfb_5bf082d29588c07f842ccde3f97243ea.png" width="270"  height="129" onerror="this.src='https://pss.bdstatic.com/static/superman/img/logo/logo_white-d0c9fe2af5.png';this.onerror=null;" usemap="#mp" /><img hidefocus="true" id="s_lg_img_aging" class='index-logo-aging-tools' src="//www.baidu.com/img/PCfb_5bf082d29588c07f842ccde3f97243ea.png" width="270" height="129" onerror="this.src='https://pss.bdstatic.com/static/superman/img/logo/logo_white-d0c9fe2af5.png';this.onerror=null;" usemap="#mp"><map name="mp" id="s_mp"><area style="cursor:pointer;outline:none;" shape="rect" coords="0,0,270,129" href="//www.baidu.com/s?wd=%E7%99%BE%E5%BA%A6%E7%83%AD%E6%90%9C&amp;sa=ire_dl_gh_logo_texing&amp;rsv_dl=igh_logo_pc" target="_blank" style="outline:none;" title="点击一下，了解更多" onmousedown=&quot;return ns_c({&#39;fm&#39;:&#39;behs&#39;,&#39;tab&#39;:&#39;bdlogo&#39;})&quot;></map></div><a href="/" id="result_logo" onmousedown="return c({'fm':'tab','tab':'logo'})"><img class="index-logo-src" src="//www.baidu.com/img/flexible/logo/pc/result.png" alt="到百度首页" title="到百度首页"><img  class='index-logo-srcnew' src="//www.baidu.com/img/flexible/logo/pc/result@2.png" alt="到百度首页" title="到百度首页"><img class='index-logo-peak' src="//www.baidu.com/img/flexible/logo/pc/peak-result.png" alt="到百度首页" title="到百度首页"></a><form name="f" id="form" action="/s" class="fm "  onsubmit="javascript:F.call('ps/sug','pssubmit');"><span id="s_kw_wrap" class="bg s_ipt_wr new-pmd quickdelete-wrap"><input type="text" class="s_ipt" name="wd" id="kw" maxlength="100" autocomplete="off"><i class="c-icon quickdelete c-color-gray2">&#xe610;</i><i class="quickdelete-line"></i></span><input type="hidden" name="rsv_spt" value="1"><input type="hidden" name="rsv_iqid" value="0x8ed02e55000a5335"><input type="hidden" name="issp" value="1"><input type="hidden" name="f" value="8"><input type="hidden" name="rsv_bp" value="0"><input type="hidden" name="rsv_idx" value="2"><input type="hidden" name="ie" value="utf-8"><input type="hidden" name="rqlang" value=""><input type="hidden" name="tn" value="baiduhome_pg" /><input type="hidden" name="ch" value=""><span class="btn_wr s_btn_wr bg" id="s_btn_wr"><input type="submit" value="百度一下" id="su" class="btn self-btn bg s_btn"></span><span class="tools"><span id="mHolder"><div id="mCon"><span>输入法</span></div><ul id="mMenu"><li><a href="javascript:;" name="ime_hw">手写</a></li><li><a href="javascript:;" name="ime_py">拼音</a></li><li class="ln"></li><li><a href="javascript:;" name="ime_cl">关闭</a></li></ul></span><span class="bd_bear_home"></span></span></form><div id="s_lm_wrap" class="
                    
                        s_lm_hide
                    
                    s-isindex-wrap
                    under-searchbox-tips
                "><div id="lm-new"></div></div></div></div><div id="u"><a class="toindex" href="/">百度首页</a><span class="toindex"></span><a href="javascript:;" name="tj_settingicon" class="pf">设置<i class="c-icon c-icon-triangle-down"></i></a><a href="https://www.baidu.com/my/index" id="user" class="username"><span class="s-top-img-wrapper"><img src="https://himg.bdimg.com/sys/portraitn/item/public.1.1d165301.HC16S9EoS2_4zgTf4zCqzw"/></span><span class="s-top-username">kienth</span></a><div class="bdpfmenu"></div></div><p class="s-skin-lm s-isindex-wrap"></p></div><div id="s_wrap" class="s-isindex-wrap"><div id="s_main" class="main clearfix c-wrapper c-wrapper-l " style=""><div id="s_mancard_main" class="s-mancacrd-main"><script>
    /* eslint-disable */
    window.isNewGridCard = 1;
</script><div class="s-menu-container"><div id="s_menu_gurd" class="s-menu-gurd c-font-medium" style=""><div id="s_ctner_menus" class="s-ctner-menus s-opacity-blank8"><div class="s-menus-outer"><div id="s_menus_wrapper" class="menus-wrapper"><span id="s_menu_mine" class="s-menu-item s-menu-mine" data-id="100">
                        我的关注
                        <span class="s-menu-item-underline"></span></span><span class="s-menu-item current" data-id="2">
                        推荐
                        <span class="s-menu-item-underline"></span></span></div><span class="s-menu-music" data-id="3"></span></div></div></div></div><div id="s_ctner_contents" class="s-ctner-contents "><div id="s_content_2" class="s-content " data-id="2"><!-- node渲染 --><link rel="stylesheet" type="text/css" href="https://pss.bdstatic.com/static/superman/css/recommand/init-c52228535a.css"/><script id="s_js_news" data-src="https://pss.bdstatic.com/static/superman/js/news_new/index-ee84d29110.js?v=md5">
    _manCard.asynLoad("s_js_news");
</script><div data-curtab id="s_xmancard_news_new" class="s-xmancard-news_new s-xmancard s-news-split" data-logactid="page-card-tpl-news_new" data-waterpara="offset=1;pos=;"><div class="s-news-wrapper clearfix"><div class="s-news-rank-wrapper s-news-special-rank-wrapper c-container-r"><!--47b7c7f9c43df831ab8e426012f79bd3--><!--pcindexnodecardcss--><style data-vue-ssr-id="d3f91faa:0">
.s-news-item {
  position: relative;
  padding: 18px 0;
  width: 100%;
  background: url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAMAAAAoyzS7AAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAAZQTFRF////AAAAVcLTfgAAAAF0Uk5TAEDm2GYAAAAMSURBVHjaYmAACDAAAAIAAU9tWeEAAAAASUVORK5CYII=') repeat;
}
.hot-news-wrapper {
  position: absolute;
  right: 0;
...
.hot-news-wrapper .s-rank-title .title-text .hotsearch-title {
  height: 14px;
  width: 59px;
  font-size: 14px;
}
.hot-news-wrapper .s-rank-title .title-text .arrow {
  font-size: 16px;
  vertical-align: top;
  color: #9195A3;
}
...
.hot-news-wrapper .s-rank-title .hot-refresh .hot-refresh-text {
  font-size: 14px;
  line-height: 14px;
  color: #626675;
}
.hot-news-wrapper .s-rank-title .hot-refresh .refresh-icon {
  margin-right: 4px;
...
.hot-news-wrapper .s-rank-title .hot-refresh .refresh-icon.rotate {
...
.hot-news-wrapper .s-news-rank-content .title-content .title-content-noindex {
  height: 4px;
  width: 4px;
  margin-right: 19px;
  margin-left: 3px;
...
.hot-news-wrapper .s-news-rank-content .title-content .title-content-top-icon {
...
.hot-news-wrapper .s-news-rank-content .title-content .title-content-title {
  font-size: 16px;
  height: 16px;
  line-height: 36px;
}
...
@media screen and (max-width: 1340px) {
  ...
  .hot-news-wrapper .s-news-rank-content #title-content.title-content {
    width: 272px;
  }
  .news-count {
    display: none;
            ...
            tpl="hot-news"
            m-name="superman-san/app/hot-news/result_a6f978f"
            m-path="https://pss.bdstatic.com/static/superman-san/app/hot-news/result_a6f978f"
B0%8F%E6%97%B6%E8%8E%B7%E4%BF%9D%E9%87%8A&sa=fyb_n_homepage&rsv_dl=fyb_n_homepage&from=super&cl=3&tn=baidutop10&fr=top1000&rsv_idx=2&hisfilter=1","pre_tag":"","count":423},{"card_title":"媒体:美国一边支持排海一边减少进口","ext":{"hotTags":0},"heat_score":4156000,"index":9,"linkurl":"https://www.baidu.com/s?wd=%E5%AA%92%E4%BD%93%3A%E7%BE%8E%E5%9B%BD%E4%B8%80%E8%BE%B9%E6%94%AF%E6%8C%81%E6%8E%92%E6%B5%B7%E4%B8%80%E8%BE%B9%E5%87%8F%E5%B0%91%E8%BF%9B%E5%8F%A3&sa=fyb_n_homepage&rsv_dl=fyb_n_homepage&from=super&cl=3&tn=baidutop10&fr=top1000&rsv_idx=2&hisfilter=1","pre_tag":"","count":415}]}--><div class="s-rank-title s-opacity-border1-bottom"><a href="https://top.baidu.com/board?platform=pc&amp;sa=pcindex_entry" target="_blank" class="hot-title"><div class="c-font-medium c-color-t title-text" aria-label="百度热搜"><i class="c-icon hotsearch-title"></i><i class="c-icon arrow"></i></div></a><a class="c-font-normal c-color-gray2 hot-refresh"><i class="c-icon refresh-icon"></i><span class="hot-refresh-text">换一换</span></a></div><ul class="s-news-rank-content"><li class="news-meta-item clearfix"><a id="title-content" class="title-content c-link c-font-medium" href="https://www.baidu.com/s?wd=%E4%B8%AD%E6%96%B9%E6%88%90%E7%AB%8B%E5%85%A8%E7%90%83%E5%8F%91%E5%B1%95%E5%92%8C%E5%8D%97%E5%8D%97%E5%90%88%E4%BD%9C%E5%9F%BA%E9%87%91&amp;sa=fyb_n_homepage&amp;rsv_dl=fyb_n_homepage&amp;from=super&amp;cl=3&amp;tn=baidutop10&amp;fr=top1000&amp;rsv_idx=2&amp;hisfilter=1" target="_blank"><i class="c-icon title-content-top-icon c-color-red c-gap-right-small"></i><span class="title-content-title">中方成立全球发展和南南合作基金</span><span class="title-content-mark c-text "></span></a></li><li class="news-meta-item clearfix"><a id="title-content" class="title-content c-link c-font-medium" href="https://www.baidu.com/s?wd=%E5%A4%9A%E5%9C%B0%E6%8F%90%E9%86%92%E5%B8%82%E6%B0%91%EF%BC%9A%E4%B8%8D%E8%A6%81%E5%9B%A4%E7%9B%90&amp;sa=fyb_n_homepage&amp;rsv_dl=fyb_n_homepage&amp;from=super&amp;cl=3&amp;tn=baidutop10&amp;fr=top1000&amp;rsv_idx=2&amp;hisfilter=1" target="_blank"><span class="title-content-index c-index-single c-index-single-hot1">1</span><span class="title-content-title">多地提醒市民：不要囤盐</span><span class="title-content-mark c-text c-text-hot">热</span></a></li><li class="news-meta-item clearfix"><a id="title-content" class="title-content c-link c-font-medium" href="https://www.baidu.com/s?wd=%E5%8D%AB%E6%98%9F%E5%9B%BE%E7%9C%8B%E7%A6%8F%E5%B2%9B%E6%A0%B8%E7%94%B5%E7%AB%9912%E5%B9%B4%E5%AF%B9%E6%AF%94&amp;sa=fyb_n_homepage&amp;rsv_dl=fyb_n_homepage&amp;from=super&amp;cl=3&amp;tn=ba
�伤的一天</span><span class="title-content-mark c-text "></span></a></li><li class="news-meta-item clearfix"><a id="title-content" class="title-content c-link c-font-medium" href="https://www.baidu.com/s?wd=%E8%8C%B6%E5%8D%A1%E7%9B%90%E6%B9%96%E7%8E%B0%E6%9C%89%E7%9B%90%E5%A4%9F%E5%85%A8%E5%9B%BD%E5%90%8370%E5%B9%B4&amp;sa=fyb_n_homepage&amp;rsv_dl=fyb_n_homepage&amp;from=super&amp;cl=3&amp;tn=baidutop10&amp;fr=top1000&amp;rsv_idx=2&amp;hisfilter=1" target="_blank"><span class="title-content-index c-index-single c-index-single-hot7">7</span><span class="title-content-title">茶卡盐湖现有盐够全国吃70年</span><span class="title-content-mark c-text "></span></a></li><li class="news-meta-item clearfix"><a id="title-content" class="title-content c-link c-font-medium" href="https://www.baidu.com/s?wd=%E7%89%B9%E6%9C%97%E6%99%AE%E8%87%AA%E9%A6%96%E5%90%8E%E4%B8%8D%E5%88%B0%E5%8D%8A%E5%B0%8F%E6%97%B6%E8%8E%B7%E4%BF%9D%E9%87%8A&amp;sa=fyb_n_homepage&amp;rsv_dl=fyb_n_homepage&amp;from=super&amp;cl=3&amp;tn=baidutop10&amp;fr=top1000&amp;rsv_idx=2&amp;hisfilter=1" target="_blank"><span class="title-content-index c-index-single c-index-single-hot8">8</span><span class="title-content-title">特朗普自首后不到半小时获保释</span><span class="title-content-mark c-text "></span></a></li><li class="news-meta-item clearfix"><a id="title-content" class="title-content c-link c-font-medium" href="https://www.baidu.com/s?wd=%E5%AA%92%E4%BD%93%3A%E7%BE%8E%E5%9B%BD%E4%B8%80%E8%BE%B9%E6%94%AF%E6%8C%81%E6%8E%92%E6%B5%B7%E4%B8%80%E8%BE%B9%E5%87%8F%E5%B0%91%E8%BF%9B%E5%8F%A3&amp;sa=fyb_n_homepage&amp;rsv_dl=fyb_n_homepage&amp;from=super&amp;cl=3&amp;tn=baidutop10&amp;fr=top1000&amp;rsv_idx=2&amp;hisfilter=1" target="_blank"><span class="title-content-index c-index-single c-index-single-hot9">9</span><span class="title-content-title">媒体:美国一边支持排海一边减少进口</span><span class="title-content-mark c-text "></span></a></li></ul></div></div></div><textarea id="news_hot_data" style="display:none;">{"banner":[]}</textarea><textarea id="news_banner_data" style="display:none;">{"isViewed": "0","url": "","img": "","title": "","bannerId": ""}</textarea><div class="water-container"><div class="s-news-list-wrapper c-container c-feed-box"><!--47b7c7f9c43df831ab8e426012f79bd3--><!--pcindexnodecardcss--><style data-vue-ssr-id="70f83a43:0 aba48888:0 4f570716:0 5c8b62c1:0">
.s-news-item {
  position: relative;
  padding: 18px 0;
  width: 100%;
...
.s-news-special-item-tpl-2 {
  display: relative;
}
.s-news-special-item-tpl-2 .s-block-container {
  position: relative;
...
.s-news-special-item-tpl-2 .s-block-container .s-news-item-title {
  margin-bottom: 6px;
}
.s-news-special-item-tpl-2 .s-block-container .s-text-content {
  padding: 0 0 0 12px;
}
.s-news-item:hover .dustbin,
.s-news-item:hover .nativead-dustbin {
  display: block;
}
...
.item-img-wrap .s-news-img {
  height: 122px;
}
.item-img-wrap .s-news-img-tpl4 {
  height: 209px;
}
.item-img-wrap .s-img-mask {
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
.item-img-wrap .s-video-playicon {
  width: 48px;
  height: 48px;
  position: absolute;
  top: 0;
...
.item-img-wrap .s-video-duration {
  position: absolute;
  bottom: 6px;
  right: 6px;
  font-size: 12px;
...
.homepage-feed-tts span {
  padding: 0 4px;
}
.homepage-feed-tts .c-icon {
  display: inline-block;
  font-size: 16px;
}
.homepage-feed-tts .play-tts {
  display: block;
}
.homepage-feed-tts .pause-tts {
  display: none;
  color: #4e6ef2;
}
.homepage-feed-tts .tts-button-text {
  display: inline-block;
  margin-left: 6px;
...
.open-homepage-tts .homepage-feed-tts {
  display: block;
}
.open-homepage-tts .has-tts .dustbin {
  right: 69px;
}

</style><!--pcindexnodecardcss--><div class="san-card"
            tpl="video"
            m-name="superman-san/app/video/result_f30158a"
            m-path="https://pss.bdstatic.com/static/superman-san/app/video/result_f30158a"
        ><div class="s-news-special s-news-item s-news-special-item-tpl-2 s-opacity-blank8 clearfix" data-url="https://mbd.baidu.com/newspage/data/videolanding?nid=sv_18289355300670994182&amp;sourceFrom=pc_feedlist" data-rid="18289355300670994182" data-log="stype:218;picNum:1;title:美国和越南坐不住了，菲律宾水泥没扔成;pos:0;st:video;" data-extra="{&quot;rec_src&quot;:[4804,9],&quot;score&quot;:41857.125,&quot;mthid&quot;:&quot;1584125536989489&quot;,&quot;q_ratio&quot;:0,&quot;recall_type&quot;:19,&quot;show&quot;:0,&quot;click&quot;:0,&quot;source&quot;:0,&quot;top&quot;:0,&quot;predictor_extmsg&quot;:&quot;EgAaChIDMjE4GgMyMTgiHRkAAAAATG6lPyBGMQAAAABMbqU\/cQAAAABMbqU\/&quot;,&quot;dnn_score_cp&quot;:0,&quot;topic_microvideo&quot;:[],&quot;recall_attention&quot;:[],&quot;predictor_result&quot;:&quot;CAEZAACw8iNw5EA5AAAAAAAAAAA=&quot;,&quot;trigger_rid&quot;:&quot;0&quot;,&quot;type&quot;:218,&quot;mark&quot;:6,&quot;th&quot;:-1,&quot;new_cate_v2&quot;:&quot;军事&quot;,&quot;new_sub_cate_v2&quot;:&quot;环球军事&quot;,&quot;gr_layout&quot;:&quot;image1&quot;,&quot;session_id&quot;:&quot;0&quot;,&quot;refresh_index&quot;:&quot;0&quot;,&quot;session_index&quot;:-1896411816,&quot;position&quot;:0,&quot;log_id&quot;:2148160309,&quot;refresh_state&quot;:0,&quot;refresh_type&quot;:1,&quot;refresh_timestamp_ms&quot;:1692932453578,&quot;news_attention&quot;:[],&quot;predictor_q_score&quot;:41857.123374939,&quot;is_microvideo&quot;:false,&quot;video_type&quot;:&quot;1&quot;,&quot;channel_id&quot;:1,&quot;templates&quot;:{&quot;id&quot;:[31],&quot;showtag&quot;:[]},&quot;wifiinfo&quot;:&quot;&quot;,&quot;gr_step_click&quot;:-1,&quot;gr_step_related_click&quot;:0,&quot;attentionnum&quot;:175,&quot;video_attentionnum&quot;:67,&quot;gr_pred_score&quot;:0.083714246749878,&quot;gr_dnn_score&quot;:0.041857123374939,&quot;gr_calibration_q&quot;:0,&quot;gr_pred_dur&quot;:0,&quot;gr_news_sub_category_single&quot;:&quot;&quot;,&quot;ext_multi_score&quot;:0,&quot;predictor_result_array&quot;:[{&quot;rec_src&quot;:9,&quot;predictorq&quot;:&quot;CAEZAACw8iNw5EA5AAAAAAAAAAA=&quot;}],&quot;user_activity_v1&quot;:2.3667047723513e-31,&quot;loc_city&quot;:&quot;北京市&quot;,&quot;pass_through&quot;:&quot;{\&quot;offset\&quot;:0,\&quot;news_num\&quot;:0,\&quot;count_svimmer_click\&quot;:0}&quot;,&quot;crudely_stat&quot;:&quot;|ct_军事|sc_环球军事|valvl_3&quot;,&quot;dispatch_timestamp&quot;:1692932453877,&quot;layout&quot;:&quot;image1&quot;}"><!--s-data:{"videoData":{"duration":"08:07","image":["https://f7.baidu.com/it/u=3864809230,1481553283&fm=222&app=106&size=f360,240&n=0&f=JPEG?sec=1693069200&t=5823ba9bfe54be5cef06e4db16914701"],"link_url":"https://mbd.baidu.com/newspage/data/videolanding?nid=sv_18289355300670994182&sourceFrom=pc_feedlist","source":"深蓝航迹","src_link":"https://author.baidu.com/home?app_id=1584125536989489&from=homepage_nickname","src_time":"08-22 16:56","tag":"","title":"美国和越南坐不住了，菲律宾水泥没扔成","gr_ext":"{\"rec_src\":[4804,9],\"score\":41857.125,\"mthid\":\"1584125536989489\",\"q_ratio\":0,\"recall_type\":19,\"show\":0,\"click\":0,\"source\":0,\"top\":0,\"predictor_extmsg\":\"EgAaChIDMjE4GgMyMTgiHRkAAAAATG6lPyBGMQAAAABMbqU\\/cQAAAABMbqU\\/\",\"dnn_score_cp\":0,\"topic_microvideo\":[],\"recall_attention\":[],\"predictor_result\":\"CAEZAACw8iNw5EA5AAAAAAAAAAA=\",\"trigger_rid\":\"0\",\"type\":218,\"mark\":6,\"th\":-1,\"new_cate_v2\":\"军事\",\"new_sub_cate_v2\":\"环球军事\",\"gr_layout\":\"image1\",\"session_id\":\"0\",\"refresh_index\":\"0\",\"session_index\":-1896411816,\"position\":0,\"log_id\":2148160309,\"refresh_state\":0,\"refresh_type\":1,\"refresh_timestamp_ms\":1692932453578,\"news_attention\":[],\"predictor_q_score\":41857.123374939,\"is_microvideo\":false,\"video_type\":\"1\",\"channel_id\":1,\"templates\":{\"id\":[31],\"showtag\":[]},\"wifiinfo\":\"\",\"gr_step_click\":-1,\"gr_step_related_click\":0,\"attentionnum\":175,\"video_attentionnum\":67,\"gr_pred_score\":0.083714246749878,\"gr_dnn_score\":0.041857123374939,\"gr_calibration_q\":0,\"gr_pred_dur\":0,\"gr_news_sub_category_single\":\"\",\"ext_multi_score\":0,\"predictor_result_array\":[{\"rec_src\":9,\"predictorq\":\"CAEZAACw8iNw5EA5AAAAAAAAAAA=\"}],\"user_activity_v1\":2.3667047723513e-31,\"loc_city\":\"北京市\",\"pass_through\":\"{\\\"offset\\\":0,\\\"news_num\\\":0,\\\"count_svimmer_click\\\":0}\",\"crudely_stat\":\"|ct_军事|sc_环球军事|valvl_3\",\"dispatch_timestamp\":1692932453877,\"layout\":\"image1\"}","pic_num":"1","stype":"218","id":"18289355300670994182","tplName":"video","layout":"s-news-special-item-tpl-2"},"pos":0}--><div class="s-pic-content  s-pic-content-tpl2"><div class="s-pic-content-own"><ul class="s-news-content-imgs clearfix"><li class="item-img-wrap c-span4 c-span-last"><a class="c-img c-img-radius-large" href="https://mbd.baidu.com/newspage/data/videolanding?nid=sv_18289355300670994182&sourceFrom=pc_feedlist" target="_blank" data-click="LOG_LINK" title="美国和越南坐不住了，菲律宾水泥没扔成" data-title="美国和越南坐不住了，菲律宾水泥没扔成"><img class="s-news-img" src="https://f7.baidu.com/it/u=3864809230,1481553283&amp;fm=222&amp;app=106&amp;size=f360,240&amp;n=0&amp;f=JPEG?sec=1693069200&amp;t=5823ba9bfe54be5cef06e4db16914701"><div class="s-img-mask c-img-radius-large"></div><img src="https://dss0.bdstatic.com/5aV1bjqh_Q23odCf/static/mantpl/img/news/video_play-dad4325811.png" class="s-video-playicon"><div class="s-video-duration">08:07</div></a></li></ul></div></div><div class="s-block-container c-span8 c-span-last"><div class="s-text-content"><a class="s-news-item-title c-link c-font-big c-gap-bottom-small title-clamp-3  " href="https://mbd.baidu.com/newspage/data/videolanding?nid=sv_18289355300670994182&sourceFrom=pc_feedlist" title="美国和越南坐不住了，菲律宾水泥没扔成" data-title="美国和越南坐不住了，菲律宾水泥没扔成" data-link="https://mbd.baidu.com/newspage/data/videolanding?nid=sv_18289355300670994182&amp;sourceFrom=pc_feedlist" data-click="LOG_LINK" target="_blank" data-type="" data-subject="" data-nid="news_18289355300670994182">美国和越南坐不住了，菲律宾水泥没扔成 </a></div><div class="from c-font-normal from-tpl2"><a class="c-gap-right c-color-gray" href="https://author.baidu.com/home?app_id=1584125536989489&from=homepage_nickname" target="_blank" data-src="1" data-click="LOG_LINK">深蓝航迹</a><span class="src-time c-color-gray2 c-gap-right">08-22 16:56</span><div class="dustbin" data-click="LOG_BTN_DUSTBIN"><i class="c-icon"></i></div></div></div></div></div><!--47b7c7f9c43df831ab8e426012f79bd3--><!--pcindexnodecardcss--><style data-vue-ssr-id="28bb74aa:0 4f570716:0 aba48888:0 5c8b62c1:0">
.s-news-item {
  position: relative;
  padding: 18px 0;
  width: 100%;
...
.s-news-item .news-readed {
  color: #626675;
}
.s-news-item .news-readed:hover,
.s-news-item .news-reading:hover {
  color: #315efb;
}
.s-news-item .news-reading {
  color: #4e6ef2;
}
.s-news-special-item-tpl-2 {
  display: relative;
...
.s-news-special-item-tpl-3 .from {
  margin-top: 7px;
}
.s-news-item:hover .dustbin,
.s-news-item:hover .nativead-dustbin {
...
.open-homepage-tts .has-tts .dustbin {
  right: 69px;
            ...
            tpl="news"
            m-name="superman-san/app/news/result_0c6ed0e"
            m-path="https://pss.bdstatic.com/static/superman-san/app/news/result_0c6ed0e"
        ><div class="s-news-special s-news-item s-news-special-item-tpl-1 s-opacity-blank8 clearfix has-tts" data-url="https://mbd.baidu.com/newspage/data/landingsuper?context=%7B%22nid%22%3A%22news_9697497767338053659%22%7D&amp;n_type=-1&amp;p_from=-1" data-rid="9697497767338053659" data-nid="news_9697497767338053659" data-log="stype:0;picNum:6;title:中国宣布28nm芯片量产，韩国半导体却先崩了：存货无数，血亏万亿;pos:0;st:news;" data-extra="{&quot;rec_src&quot;:[4201,4035],&quot;type&quot;:0,&quot;score&quot;:121248.4921875,&quot;mark&quot;:0,&quot;recall_type&quot;:1,&quot;vertical_type&quot;:5,&quot;mthid&quot;:&quot;1764130390827545&quot;,&quot;predictor_result&quot;:&quot;CAEZAICU2wea\/UA5AAAAAAAAAAA=&quot;,&quot;q_ratio&quot;:1,&quot;recall_attention&quot;:[&quot;中芯国际集成电路制造有限公司&quot;],&quot;img_num&quot;:6,&quot;sample_name&quot;:&quot;integration_news&quot;,&quot;predictor_extmsg&quot;:&quot;EgAiHRkAAAAgJAq\/PyBFMQAAACAkCr8\/cQAAACAkCr8\/&quot;,&quot;dnn_score_cp&quot;:0,&quot;th&quot;:-1,&quot;gr_layout&quot;:&quot;image3&quot;,&quot;session_id&quot;:&quot;0&quot;,&quot;refresh_index&quot;:&quot;0&quot;,&quot;session_index&quot;:-1896411816,&quot;position&quot;:1,&quot;log_id&quot;:2148160309,&quot;refresh_state&quot;:0,&quot;refresh_type&quot;:1,&quot;refresh_timestamp_ms&quot;:1692932453578,&quot;news_attention&quot;:[&quot;28nm&quot;,&quot;28nm芯片&quot;,&quot;半导体&quot;,&quot;半导体产业&quot;,&quot;半导体芯片&quot;,&quot;韩国&quot;,&quot;韩国半导体&quot;,&quot;数码&quot;,&quot;芯片&quot;,&quot;中国&quot;,&quot;中芯国际&quot;,&quot;中芯国际集成电路制造有限公司&quot;,&quot;走遍全球：韩国&quot;],&quot;predictor_q_score&quot;:121248.49110842,&quot;is_microvideo&quot;:false,&quot;video_type&quot;:&quot;&quot;,&quot;channel_id&quot;:1,&quot;templates&quot;:{&quot;id&quot;:[33],&quot;showtag&quot;:[]},&quot;wifiinfo&quot;:&quot;&quot;,&quot;gr_step_click&quot;:-1,&quot;gr_step_related_click&quot;:0,&quot;attentionnum&quot;:175,&quot;video_attentionnum&quot;:67,&quot;gr_pred_score&quot;:0.083830151734646,&quot;gr_dnn_score&quot;:0.12124849110842,&quot;gr_calibration_q&quot;:0,&quot;gr_pred_dur&quot;:0,&quot;gr_news_sub_category_single&quot;:&quot;其他数码产品&quot;,&quot;ext_multi_score&quot;:0,&quot;predictor_result_array&quot;:[{&quot;rec_src&quot;:4201,&quot;predictorq&quot;:&quot;CAEZAICU2wea\/UA5AAAAAAAAAAA=&quot;},{&quot;rec_src&quot;:4035,&quot;predictorq&quot;:&quot;CAEZAAASCMDN+0A5AAAAAAAAAAA=&quot;}],&quot;user_activity_v1&quot;:2.3667047723513e-31,&quot;loc_city&quot;:&quot;北京市&quot;,&quot;pass_through&quot;:&quot;{\&quot;offset\&quot;:0,\&quot;news_num\&quot;:0,\&quot;count_svimmer_click\&quot;:0}&quot;,&quot;crudely_stat
"attentionnum\":175,\"video_attentionnum\":67,\"gr_pred_score\":0.083830151734646,\"gr_dnn_score\":0.12124849110842,\"gr_calibration_q\":0,\"gr_pred_dur\":0,\"gr_news_sub_category_single\":\"其他数码产品\",\"ext_multi_score\":0,\"predictor_result_array\":[{\"rec_src\":4201,\"predictorq\":\"CAEZAICU2wea\\/UA5AAAAAAAAAAA=\"},{\"rec_src\":4035,\"predictorq\":\"CAEZAAASCMDN+0A5AAAAAAAAAAA=\"}],\"user_activity_v1\":2.3667047723513e-31,\"loc_city\":\"北京市\",\"pass_through\":\"{\\\"offset\\\":0,\\\"news_num\\\":0,\\\"count_svimmer_click\\\":0}\",\"crudely_stat\":\"|ct_数码|sc_其他数码产品|nalvl_3\",\"dispatch_timestamp\":1692931253877,\"layout\":\"image3\"}","pic_num":"6","stype":"0","id":"9697497767338053659","tplName":"news","layout":"s-news-special-item-tpl-1","istts":"1"},"pos":0}--><a class="s-news-item-title c-link c-font-big  title-clamp-2  has-tts" href="https://mbd.baidu.com/newspage/data/landingsuper?context=%7B%22nid%22%3A%22news_9697497767338053659%22%7D&n_type=-1&p_from=-1" title="中国宣布28nm芯片量产，韩国半导体却先崩了：存货无数，血亏万亿" data-title="中国宣布28nm芯片量产，韩国半导体却先崩了：存货无数，血亏万亿" data-link="https://mbd.baidu.com/newspage/data/landingsuper?context=%7B%22nid%22%3A%22news_9697497767338053659%22%7D&amp;n_type=-1&amp;p_from=-1" data-click="LOG_LINK" target="_blank" data-type="news" data-subject="" data-nid="news_9697497767338053659">中国宣布28nm芯片量产，韩国半导体却先崩了：存货无数，血亏万亿 </a><div class="s-pic-content c-gap-top-large c-gap-bottom s-pic-content-tpl1"><ul class="s-news-content-imgs clearfix"><li class="item-img-wrap c-span4 "><a class="c-img c-img-radius-left-l c-img-radius-right-s" href="https://mbd.baidu.com/newspage/data/landingsuper?context=%7B%22nid%22%3A%22news_9697497767338053659%22%7D&n_type=-1&p_from=-1" target="_blank" data-click="LOG_LINK" title="中国宣布28nm芯片量产，韩国半导体却先崩了：存货无数，血亏万亿" data-title="中国宣布28nm芯片量产，韩国半导体却先崩了：存货无数，血亏万亿"><img class="s-news-img " src="https://gimg3.baidu.com/search/src=http%3A%2F%2Fpics1.baidu.com%2Ffeed%2Ff9dcd100baa1cd11122de213aba266f0c2ce2da2.jpeg%40f_auto%3Ftoken%3De9b728078b39d1ef1f7f10dfb1c7539b&amp;refer=http%3A%2F%2Fwww.baidu.com&amp;app=2021&amp;size=f360,240&amp;n=0&amp;g=0n&amp;q=75&amp;fmt=auto?sec=1693069200&amp;t=3318d91b16ff5d363de90abb04ea93e0"><div class="s-img-mask c-img-radius-left-l c-img-radius-right-s"></div></a></li><li class="item-img-wrap c-span4 "><a class="c-img c-img-radius-s" href="https://mbd.baidu.com/newspage/data/landingsuper?context=%7B%22nid%22%3A%22news_9697497767338053659%22%7D&n_type=-1&p_from=-1" target="_blank" data-click="LOG_LINK" title="中国宣布28nm芯片量产，韩国半导体却先崩了：存货无数，血亏万亿" data-title="中国宣布28nm芯片量产，韩国半导体却先崩了：存货无数，血亏万亿"><img class="s-news-img " src="https://gimg3.baidu.com/search/src=http%3A%2F%2Fpics2.baidu.com%2Ffeed%2F359b033b5bb5c9ea121ca6ffc789180c3bf3b37f.jpeg%40f_auto%3Ftoken%3Ddfefa7f984106c04aa9356c2b0d46695&amp;refer=http%3A%2F%2Fwww.baidu.com&amp;app=2021&amp;size=f360,240&amp;n=0&amp;g=0n&amp;q=75&amp;fmt=auto?sec=1693069200&amp;t=41a43772e90e88fcd5634db6be024da7"><div class="s-img-mask c-img-radius-s"></div></a></li><li class="item-img-wrap c-span4 c-span-last"><a class="c-img c-img-radius-right-l c-img-radius-left-s" href="https://mbd.baidu.com/newspage/data/landingsuper?context=%7B%22nid%22%3A%22news_9697497767338053659%22%7D&n_type=-1&p_from=-1" target="_blank" data-click="LOG_LINK" title="中国宣布28nm芯片量产，韩国半导体却先崩了：存货无数，血亏万亿" data-title="中国宣布28nm芯片量产，韩国半导体却先崩了：存货无数，血亏万亿"><img class="s-news-img " src="https://gimg3.baidu.com/search/src=http%3A%2F%2Fpics3.baidu.com%2Ffeed%2Fb2de9c82d158ccbf59f334e10b681232b33541de.jpeg%40f_auto%3Ftoken%3Deb49c91daec53b871e6047dab5740510&amp;refer=http%3A%2F%2Fwww.baidu.com&amp;app=2021&amp;size=f360,240&amp;n=0&amp;g=0n&amp;q=75&amp;fmt=auto?sec=1693069200&amp;t=a2d94973818ebf4c0b09f03e4fc97075"><div class="s-img-mask c-img-radius-right-l c-img-radius-left-s"></div></a></li></ul></div><div class="from c-font-normal "><a class="c-gap-right c-color-gray" href="https://author.baidu.com/home?app_id=1764130390827545&from=homepage_nickname" target="_blank" data-src="1" data-click="LOG_LINK">小娅科技聚焦</a><span class="src-time c-color-gray2 c-gap-right">08-24 19:33</span><div class="dustbin" data-click="LOG_BTN_DUSTBIN"><i class="c-icon"></i></div><div class="homepage-feed-tts"><span class="play-tts" data-nid="news_9697497767338053659"><i class="c-icon"></i><p class="tts-button-text">播报</p></span><span class="pause-tts" data-nid="news_9697497767338053659"><i class="c-icon"></i><p class="tts-button-text">暂停</p></span></div></div></div></div><!--47b7c7f9c43df831ab8e426012f79bd3--><!--pcindexnodecardcss--><style data-vue-ssr-id="70f83a43:0 aba48888:0 4f570716:0 5c8b62c1:0">
.s-news-item {
  position: relative;
  padding: 18px 0;
  width: 100%;
...
.open-homepage-tts .has-tts .dustbin {
  right: 69px;
            ...
            m-name="superman-san/app/video/result_f30158a"
            m-path="https://pss.bdstatic.com/static/superman-san/app/video/result_f30158a"
        ><div class="s-news-special s-news-item s-news-special-item-tpl-2 s-opacity-blank8 clearfix" data-url="https://mbd.baidu.com/newspage/data/videolanding?nid=sv_5429341464115580601&amp;sourceFrom=pc_feedlist" data-rid="5429341464115580601" data-log="stype:218;picNum:1;title:真实当一天奥迪Q6的车主，这才是中国家庭想要的车｜特别任务;pos:0;st:video;" data-extra="{&quot;rec_src&quot;:[4804,9],&quot;score&quot;:28471.81640625,&quot;mthid&quot;:&quot;1541611164797357&quot;,&quot;q_ratio&quot;:0,&quot;recall_type&quot;:1,&quot;show&quot;:0,&quot;click&quot;:0,&quot;source&quot;:0,&quot;top&quot;:0,&quot;predictor_extmsg&quot;:&quot;EgAaChIDMjE4GgMyMTgiHRkAAABAtyedPyBGMQAAAEC3J50\/cQAAAEC3J50\/&quot;,&quot;dnn_score_cp&quot;:0,&quot;topic_microvideo&quot;:[],&quot;recall_attention&quot;:[],&quot;predictor_result&quot;:&quot;CAEZAADFPvTN20A5AAAAAAAAAAA=&quot;,&quot;trigger_rid&quot;:&quot;0&quot;,&quot;type&quot;:218,&quot;mark&quot;:6,&quot;th&quot;:-1,&quot;new_cate_v2&quot;:&quot;汽车&quot;,&quot;new_sub_cate_v2&quot;:&quot;评测导购&quot;,&quot;gr_layout&quot;:&quot;image1&quot;,&quot;session_id&quot;:&quot;0&quot;,&quot;refresh_index&quot;:&quot;0&quot;,&quot;session_index&quot;:-1896411816,&quot;position&quot;:2,&quot;log_id&quot;:2148160309,&quot;refresh_state&quot;:0,&quot;refresh_type&quot;:1,&quot;refresh_timestamp_ms&quot;:1692932453578,&quot;news_attention&quot;:[],&quot;predictor_q_score&quot;:28471.816331148,&quot;is_microvideo&quot;:false,&quot;video_type&quot;:&quot;1&quot;,&quot;channel_id&quot;:1,&quot;templates&quot;:{&quot;id&quot;:[31],&quot;showtag&quot;:[]},&quot;wifiinfo&quot;:&quot;&quot;,&quot;gr_step_click&quot;:-1,&quot;gr_step_related_click&quot;:0,&quot;attentionnum&quot;:175,&quot;video_attentionnum&quot;:67,&quot;gr_pred_score&quot;:0.064974238267581,&quot;gr_dnn_score&quot;:0.028471816331148,&quot;gr_calibration_q&quot;:0,&quot;gr_pred_dur&quot;:0,&quot;gr_news_sub_category_single&quot;:&quot;&quot;,&quot;ext_multi_score&quot;:0,&quot;predictor_result_array&quot;:[{&quot;rec_src&quot;:9,&quot;predictorq&quot;:&quot;CAEZAADFPvTN20A5AAAAAAAAAAA=&quot;}],&quot;user_activity_v1&quot;:2.3667047723513e-31,&quot;loc_city&quot;:&quot;北京市&quot;,&quot;pass_through&quot;:&quot;{\&quot;offset\&quot;:0,\&quot;news_num\&quot;:0,\&quot;count_svimmer_click\&quot;:0}&quot;,&quot;crudely_stat&quot;:&quot;|ct_汽车|sc_评测导购|valvl_3&quot;,&quot;dispatch_timestamp&quot;:1692930053877,&quot;layout&quot;:&quot;image1&quot;}"><!--s-data:{"videoData":{"duration":"12:57","image":["https://f7.baidu.com/it/u=2145560548,3243186041&fm=222&app=106&size=f360,240&n=0&f=JPEG?sec=1693069200&t=148a810a7303bb78ee29e6c8ad4cbcaa"],"link_url":"https://mbd.baidu.com/newspage/data/videolanding?nid=sv_5429341464115580601&sourceFrom=pc_feedlist","source":"蜗牛车志","src_link":"https://author.baidu.com/home?app_id=1541611164797357&from=homepage_nickname","src_time":"08-09 14:57","tag":"","title":"真实当一天奥迪Q6的车主，这才是中国家庭想要的车｜特别任务","gr_ext":"{\"rec_src\":[4804,9],\"score\":28471.81640625,\"mthid\":\"1541611164797357\",\"q_ratio\":0,\"recall_type\":1,\"show\":0,\"click\":0,\"source\":0,\"top\":0,\"predictor_extmsg\":\"EgAaChIDMjE4GgMyMTgiHRkAAABAtyedPyBGMQAAAEC3J50\\/cQAAAEC3J50\\/\",\"dnn_score_cp\":0,\"topic_microvideo\":[],\"recall_attention\":[],\"predictor_result\":\"CAEZAADFPvTN20A5AAAAAAAAAAA=\",\"trigger_rid\":\"0\",\"type\":218,\"mark\":6,\"th\":-1,\"new_cate_v2\":\"汽车\",\"new_sub_cate_v2\":\"评测导购\",\"gr_layout\":\"image1\",\"session_id\":\"0\",\"refresh_index\":\"0\",\"session_index\":-1896411816,\"position\":2,\"log_id\":2148160309,\"refresh_state\":0,\"refresh_type\":1,\"refresh_timestamp_ms\":1692932453578,\"news_attention\":[],\"predictor_q_score\":28471.816331148,\"is_microvideo\":false,\"video_type\":\"1\",\"channel_id\":1,\"templates\":{\"id\":[31],\"showtag\":[]},\"wifiinfo\":\"\",\"gr_step_click\":-1,\"gr_step_related_click\":0,\"attentionnum\":175,\"video_attentionnum\":67,\"gr_pred_score\":0.064974238267581,\"gr_dnn_score\":0.028471816331148,\"gr_calibration_q\":0,\"gr_pred_dur\":0,\"gr_news_sub_category_single\":\"\",\"ext_multi_score\":0,\"predictor_result_array\":[{\"rec_src\":9,\"predictorq\":\"CAEZAADFPvTN20A5AAAAAAAAAAA=\"}],\"user_activity_v1\":2.3667047723513e-31,\"loc_city\":\"北京市\",\"pass_through\":\"{\\\"offset\\\":0,\\\"news_num\\\":0,\\\"count_svimmer_click\\\":0}\",\"crudely_stat\":\"|ct_汽车|sc_评测导购|valvl_3\",\"dispatch_timestamp\":1692930053877,\"layout\":\"image1\"}","pic_num":"1","stype":"218","id":"5429341464115580601","tplName":"video","layout":"s-news-special-item-tpl-2"},"pos":0}--><div class="s-pic-content  s-pic-content-tpl2"><div class="s-pic-content-own"><ul class="s-news-content-imgs clearfix"><li class="item-img-wrap c-span4 c-span-last"><a class="c-img c-img-radius-large" href="https://mbd.baidu.com/newspage/data/videolanding?nid=sv_5429341464115580601&sourceFrom=pc_feedlist" target="_blank" data-click="LOG_LINK" title="真实当一天奥迪Q6的车主，这才是中国家庭想要的车｜特别任务" data-title="真实当一天奥迪Q6的车主，这才是中国家庭想要的车｜特别任务"><img class="s-news-img" src="https://f7.baidu.com/it/u=2145560548,3243186041&amp;fm=222&amp;app=106&amp;size=f360,240&amp;n=0&amp;f=JPEG?sec=1693069200&amp;t=148a810a7303bb78ee29e6c8ad4cbcaa"><div class="s-img-mask c-img-radius-large"></div><img src="https://dss0.bdstatic.com/5aV1bjqh_Q23odCf/static/mantpl/img/news/video_play-dad4325811.png" class="s-video-playicon"><div class="s-video-duration">12:57</div></a></li></ul></div></div><div class="s-block-container c-span8 c-span-last"><div class="s-text-content"><a class="s-news-item-title c-link c-font-big c-gap-bottom-small title-clamp-3  " href="https://mbd.baidu.com/newspage/data/videolanding?nid=sv_5429341464115580601&sourceFrom=pc_feedlist" title="真实当一天奥迪Q6的车主，这才是中国家庭想要的车｜特别任务" data-title="真实当一天奥迪Q6的车主，这才是中国家庭想要的车｜特别任务" data-link="https://mbd.baidu.com/newspage/data/videolanding?nid=sv_5429341464115580601&amp;sourceFrom=pc_feedlist" data-click="LOG_LINK" target="_blank" data-type="" data-subject="" data-nid="news_5429341464115580601">真实当一天奥迪Q6的车主，这才是中国家庭想要的车｜特别任务 </a></div><div class="from c-font-normal from-tpl2"><a class="c-gap-right c-color-gray" href="https://author.baidu.com/home?app_id=1541611164797357&from=homepage_nickname" target="_blank" data-src="1" data-click="LOG_LINK">蜗牛车志</a><span class="src-time c-color-gray2 c-gap-right">08-09 14:57</span><div class="dustbin" data-click="LOG_BTN_DUSTBIN"><i class="c-icon"></i></div></div></div></div></div></div></div></div></div><script>
            if (typeof F === 'object') {
                F.call('superman:components/initSan', 'init');
            }
            </script><div class="s-loading s-opacity-border4-top" style="display:none;border:none;"><img src="https://pss.bdstatic.com/static/superman/img/loading_new-f4a658cef0.gif"/></div></div></div><div class="s-more-bar c-color-gray2" style="visibility:hidden"><div class="rect"><div class="animate-arrow c-icon">&#xe615;</div></div></div><textarea id="s_menus_textarea" style="display:none;">
{
    "data": [
...
bds.comm.personalData = 
{
        ...
        "cardsFrom":"{\&quot;2&quot;:1,&quot;1&quot;:1,&quot;15&quot;:1,&quot;5&quot;:1,&quot;23&quot;:1,&quot;20&quot;:1,&quot;3&quot;:1}"
        
        ,
        "city_weather":"0"
        
        ,
        "click_site":"a:3:{i:0;s:17:\&quot;5522592&amp;754104988&quot;;i:1;s:18:&quot;11693627&amp;264945769&quot;;i:2;s:17:&quot;8070131&amp;787962121&quot;;}"
        ...
        ,
        "skinHistory":"super_822"
        
        ,
        "skinUrl":"super_822"
        
        ,
        "skinUrlHis":"super_822"
        ...
        ,
        "userCards":"{\&quot;_sort_card&quot;:true,&quot;2&quot;:&quot;on&quot;,&quot;1&quot;:&quot;on&quot;,&quot;15&quot;:&quot;on&quot;,&quot;5&quot;:&quot;on&quot;,&quot;23&quot;:&quot;off&quot;,&quot;20&quot;:&quot;off&quot;,&quot;3&quot;:&quot;off&quot;}"
    ...
    "ssllist": 
{
    ...
    var s_session={
        ...
        "sessionId":"",
        "rids":"",
        "seqId":"0x8ed02e55000a5335",
        "qid":"0x8ed02e55000a5335",
        "debug":false,
        "portrait":"public.1.1d165301.HC16S9EoS2_4zgTf4zCqzw",
        "logPortrait":"",
        "portraitSkin2nd":"b8366b69656e74683f04",
        "userProp":
{
...
,
        ...
        "userSkinDefined":"off",
        "userLogoSrc":"\//www.baidu.com/img/PCfb_5bf082d29588c07f842ccde3f97243ea.png",
        "userLogoSrcRe":"\//www.baidu.com/img/PCfb_5bf082d29588c07f842ccde3f97243ea.png",
        ...
        "userBirthday":"",
        "yuce":"",
        "sid":"36545_39223_39097_39193_39039_39198_39240_26350_39239_39138_39225_22158_39101",
        "mSid":"",
        "sample_value":"",
        "strategy_hit":"",
        "issync":"",
...
;bds.comm.sIndex=0;$(document.body).attr("link","#0000cc");index_links=[];$("head").find("link").each(function(){if($(this).attr("data-for")!=="result"){index_links.push(this);$(this).remove()}});index_is_css.remove();index_head_css.remove();$("#head_wrapper").css({width:"",marginBottom:0});$("#ai-talk-container").remove();$(".ai-container-style").remove();$("#kw").css("font-family","");var decodeHTML=function(source){var str=String(source).replace(/&quot;/g,'"').replace(/&lt;/g,"<").replace(
/&gt;/g,">").replace(/&amp;/g,"&");return str.replace(/&#([\d]+);/g,function(_0,_1){return String.fromCharCode(parseInt(_1,10))})};$("head").append(decodeHTML($("#s_index_off_css").html()));$("head").append(decodeHTML($("#s_is_result_css").html()));$(".s-tips-skin").remove();$(".s-skin-container").remove();$("#s_mancard_newmusic").remove();head_index_css.remove();$("#s-hotsearch-wrapper").remove();$("#s_side_wrapper").remove();$("#blind-box").remove();$("#s_popup_advert").remove();$(
"#video-meeting").remove();var isPreSearchboxGray=bds.comm.isPreSearchboxGray||"0";var $body=$("body");if(isPreSearchboxGray==="0"){$body.hasClass("big-event-gray")&&$("body").removeClass("big-event-gray");changeResultLogo(resultLogo,resultNewLogo,resultPeakLogo)}if(isPreSearchboxGray==="1"&&!$body.hasClass("big-event-gray")){$("body").addClass("big-event-gray");changeResultLogo(resultGray,resultGray,resultGray)}}})();</script><!--[if < IE 9]><script type="text/javascript" src="https://pss.bdstatic.com/static/superman/js/polyfill-ie8-30f98ab294.js"></script><![endif]--><script type="text/javascript" src="https://pss.bdstatic.com/static/superman/js/sbase-0432cf712c.js"></script><link href="https://pss.bdstatic.com/static/superman/css/ubase_sync-d600f57804.css?v=md5" type="text/css" rel="stylesheet" InlineContent /><script>F._setMod("superman");F._fileMap({"/js/sbase-0432cf712c.js":["lib/event.ts","lib/extract_data.ts","lib/commonUtils.ts","plugin/browser","plugin/strpx","plugin/url","plugin/ajax","plugin/load_file","plugin/string","plugin/stringify","plugin/localstorage","plugin/fn","plugin/easing","plugin/mousewheel","plugin/cookie","lib/base","lib/sbase","lib/class","lib/mod_evt","lib/log","lib/thunder","lib/utils.js","common/user_attr","common/select","common/bottom_layer"],"js/polyfill-ie8-30f98ab294.js":[
"polyfill/object-define-property","polyfill/object-keys"],"/js/min_super-0c0b791c0d.js":["common/result_page","common/image_lazy_load","log/webb.min","log/super_all","lib/carditem_log","ps/log","ps/sindex","ps/sug","ps/fpid","start/super_start","page/info","page/scroll"],"/js/super_ext-a0b60bd05d.js":["plugin/mousewheel","weather/setting_refresh","weather/setting_ctrl","weather/setting_view","weather/weather_city"],"/js/resource_error_monitor-ed61c2f0be.js":["page/resource_error_monitor.ts"],
"/js/super_load-86e18c5005.js":["weather/weather_tpl","weather/weather_ctrl","weather/weather_autorefresh","start/skin_start","skin/skin_rewrite","mngr/top_layer","mngr/menu_user","mngr/menu_common","mngr/quit_dialog","mngr/top_menunav_new","common/guide_tip","page/page_exp"],"/js/skin_layer-72c77f7044.js":["skin/skin_init_new","skin/skin_cut_img","skin/skin_model","skin/skin_nav","skin/skin_page","skin/skin_tools","skin/skin_img","skin/skin_control_new","skin/skin_view","skin/skin_new_upload",
"skin/skin_setting","skin/skin_preview","skin/skin_defined","skin/skin_opacity","skin/skin_ajax","skin/skin_extra","skin/skin_random"],"/js/opacity_mod-57b92b76b5.js":["opacity/opacity_tpl","opacity/opacity_action","opacity/opacity_conf"],"/js/min_setting-c3f73c1e26.js":["setting/setting_constructor","setting/mod_drag","setting/setting_action"],"/js/page_setting-f890166cc6.js":["log/super_all","setting/page_setting","setting/tab_msg","start/page_setting_start","common/pop","setting/yaohao",
"msg/const","setting/data_adapter","msg/bind","msg/bind_window","setting/common_setting"],"/js/mancard-b2e42611cf.js":["skeleton/card","skeleton/model","skeleton/card_collection","skeleton/card_showLog","skeleton/card_alsLog","skeleton/presenter","skeleton/card_tab","skeleton/card_refresh","skeleton/toast","setting/card_setting","subscribe/parabola","subscribe/subscribe"],"/js/subscribe-d2630c5b22.js":["subscribe/subscribe"],"/js/s_super_index-3fffae8d60.js":["ps/autohover_input",
"page/ua_monitor"],"/js/s_super_async-63a29db1f2.js":["components/initSan.ts","node_modules/@searchfe/inject-js/dist/amd/index.js","node_modules/@searchfe/reflect-metadata/Reflect.js","ps/autohover_input","components/drag/dragComponent","components/drag/dragEmitter","components/drag/dragTool","components/drag/draggable","components/drag/dragsort","components/drag/dragdir"],"/js/min_mt-3df544d11c.js":["msg/const","msg/data_server","msg/data_adapter"],"/js/components/content-info-12dbf9fb6d.js":[
"components/content-info.ts"],"/js/components/ai-talk-switch-c2572e6a36.js":["components/ai-talk-switch.ts"],"/js/mt_ext-4eee81afe1.js":["msg/index_nav_msg_extend","msg/msg_builder","msg/bind","msg/bind_window"],"/js/min_notice-605fc17cf9.js":["mt/mt_show","mt/mt_msg_constructor"],"/js/notice_ext-0bfec0da78.js":["mt/mt_ext","mt/mt_msg_item","mt/mt_msg_operate"],"/js/ps/ishttps-8b74cccb13.js":["ps/ishttps"],"/js/ps/async-destroy-1d5396cbf8.js":["ps/async-destroy"],
"/js/lib/exception-13bf584742.js":["lib/exception"],"/js/lib/jquery-1-edb203c114.10.2.js":["lib/jquery-1.10.2"],"/js/lib/esl-d776bfb1aa.js":["lib/esl"],"/js/ps/yc-4c3e9b9cb3.js":["ps/yc"],"/js/components/hotsearch-5af0f864cf.js":["components/hotsearch"],"/js/components/qrcode-0e4b67354f.js":["components/qrcode"],"/js/components/advert-064271ed9b.js":["components/advert"],"/js/components/nav-d9eab6af09.js":["components/nav"],"/js/components/tips-e2ceadd14d.js":["components/tips"],
"/js/components/guide-8759cd328f.js":["components/guide"],"/js/components/bbox/bbox-view-df7e8cb3b0.js":["components/bbox/bbox_view.ts","components/bbox/bbox_animate.ts"],"/js/components/guide_tips-d9e617f782.js":["components/guide_tips.ts"],"/js/components/login_guide-4fba3971ce.js":["components/login_guide.ts"],"/js/components/video-meet-7833028d86.js":["components/video-meet.ts"],"/amd_modules/@baidu/video-meeting-1be7f62dac.js":["@baidu/video-meeting/dist/index","@baidu/video-meeting"],
"/amd_modules/@baidu/aging-tools-pc-1e5afe8bdf.js":["@baidu/aging-tools-pc/dist/index","@baidu/aging-tools-pc"],"/amd_modules/@baidu/ai-search-box-entry-ea20fec552.js":["@baidu/ai-search-box-entry/dist/js/index"],"/js/components/aging-tools-35648b2e67.js":["components/aging-tools.ts"],"/amd_modules/tslib-c95383af0c.js":["tslib","./tslib/tslib"],"/js/components/invoke-97e9694cb9.js":["components/invoke.ts"],"/js/news_new/index-ee84d29110.js":["news_new/init_tts","news_new/card_alsLog",
"news_new/ck","news_new/index_view","news_new/index"],"/js/min_tips-3c72b5b27b.js?v=md5":["log/log","start/tips_start"],"/js/ubase-dddde7cd4e.js?v=md5":["superuijs/superui","superuijs/util/tool","superuijs/util/emitter","superuijs/util/dot","superuijs/util/smDot","superuijs/component","superuijs/component/draggable","superuijs/component/scrollbar","superuijs/component/dialog","superuijs/component/tips","superuijs/component/share","superuijs/component/share2","superuijs/component/notify",
"superuijs/component/suggestion","superuijs/component/placeholder"],"/js/ubase_unused-e357fff740.js?v=md5":["superuijs/component/draggsort","superuijs/component/draggselect","superuijs/component/draggdirs"],"/js/utils-ce7201f913.js?v=md5":["superuijs/util/pubsub"],"/css/super_ext-36b360db2f.css":["mngr_quit_guid.css"],"/css/components/user_quit_dialog-527f3ede74.css":["components/user_quit_dialog.css"],"/css/super_min-6f52ab3317.css":["super_init.css","skin.css","super_skin.css","select.css",
"index_guide.css"],"/css/skin/skin_layer-d2120713ac.css":["skin/skin_layer.css"],"/css/guidetip-b41ed60c8a.css":["guide.css"],"/css/nsguide-a66438b784.css":["ns_guide.css"],"/css/setting_min-4dae12391e.css":["setting.css"],"/css/card_setting-673b2943c1.css":["card_setting.css"],"/css/page_setting-da9f239ab9.css":["super_setting.css","select.css","setting_msg.css","setting_yaohao.css","pop.css","dialog.css"],"/css/mt_min-88763bc1c9.css":["mt_mod.css","index_msg.css"],
"/css/pages/index-b0b3304de9.css":["pages/index.css","components/qrcode_new.css"],"/css/pages/index_result-3a33835e40.css":["pages/index_result.css"],"/css/pages/result-7014ae574c.css":["pages/result.css"],"/css/pages/ps-56e3b78e0f.css":["pages/ps.css","grid/grid.css"],"/css/weather/weather_new-4aa68cfe53.css":["weather/weather_new.css","weather/weather_setting_new.css"],"/css/pages/common-ca1bebedbc.css":["components/head_wrapper_new.css","s_top_wrap_new.css","components/topmenu_new.css",
"bottom_layer.css","components/blind_box.css","popup_advert.css","components/guide_info.css","components/aging_tool.css","components/gray.css","components/drag.css"],"/css/components/hotsearch-6439b0f1a1.css":["components/hotsearch.css"],"/css/components/nav-ffd5baab45.css":["components/nav.css"],"/css/card_min2-74239a33b9.css":["card_menu2.css","card_side2.css"],"/css/recommand/init-c52228535a.css":["news_new/init.css","news_new/waterfall.css","news_new/custom_sui.css","news_new/hot_search.css"
,"news_new/dialog.css"],"/css/ubase_sync-d600f57804.css?v=md5":["scrollbar_sync.css"],"/css/ubase-89d6b96e41.css?v=md5":["superui/superui.css","superui/dialog.css","superui/tips.css","superui/share.css","superui/scrollbar.css","superui/suggestion.css"],"/css/ubase_sync-d600f57804.css?v=md5":["superui/scrollbar_sync.css"]});window._xman_speed=window._xman_speed||{};F._setContext({base:"lib/sbase"});F.use("lib/mod_evt",function(evt){F._setContextMethod("fire",function(evtName,evtArgs){
return evt.fire(this.svnMod+":"+this.modName,evtName,evtArgs)});F._setContextMethod("listen",function(modName,evtName,handler){var mType=Object.prototype.toString.call(modName);if(mType=="[object String]"){if(modName.indexOf(":")<0){modName=this.svnMod+":"+modName}}else if(mType=="[object Array]"){for(var i=0,len=modName.length;i<len;i++){if(modName[i].indexOf(":")<0){modName[i]=this.svnMod+":"+modName[i]}}}evt.on(modName,evtName,handler)});F._setContextMethod("unListen",function(modName,evtName
,handler){evt.un(this.svnMod+":"+this.modName,evtName,handler)})});F._loadScriptTimeout=15e3;F._useConfig=true;F._firstScreenCSS=F._firstScreenCSS||[];F._firstScreenCSS.push("/css/super_min-6f52ab3317.css");F._firstScreenJS=F._firstScreenJS||[];F._firstScreenJS.push("/js/min_super-0c0b791c0d.js");</script><script>
...
amd[item][key]=config[item][key]}}}}}};s_domain.amd=amd;var staticUrl=s_domain.staticUrl+"static/superman/";amd.addPaths({"@baidu/video-meeting":staticUrl+"amd_modules/@baidu/video-meeting-1be7f62dac.js","superman/components/video-meet":staticUrl+"js/components/video-meet-7833028d86.js",tslib:staticUrl+"amd_modules/tslib-c95383af0c.js","superman/components/guide_tips":staticUrl+"js/components/guide_tips-d9e617f782.js",
"superman/components/login_guide":staticUrl+"js/components/login_guide-4fba3971ce.js","superman/components/bbox/bbox_view":staticUrl+"js/components/bbox/bbox-view-df7e8cb3b0.js","@baidu/aging-tools-pc":staticUrl+"amd_modules/@baidu/aging-tools-pc-1e5afe8bdf.js","superman/components/aging-tools":staticUrl+"js/components/aging-tools-35648b2e67.js","superman/components/ai-talk-switch":staticUrl+"js/components/ai-talk-switch-c2572e6a36.js",
"superman/components/content-info":staticUrl+"js/components/content-info-12dbf9fb6d.js","superman/components/invoke":staticUrl+"js/components/invoke-97e9694cb9.js","ai-search-box-entry":staticUrl+"/amd_modules/@baidu/ai-search-box-entry-ea20fec552.js"})})();</script><script>F._setMod("superman");F._fileMap({"/js/sbase-0432cf712c.js":["lib/event.ts","lib/extract_data.ts","lib/commonUtils.ts","plugin/browser","plugin/strpx","plugin/url","plugin/ajax","plugin/load_file","plugin/string","plugin/stringify","plugin/localstorage","plugin/fn","plugin/easing","plugin/mousewheel","plugin/cookie","lib/base","lib/sbase","lib/class","lib/mod_evt","lib/log","lib/thunder","lib/utils.js","common/user_attr","common/select","common/bottom_layer"],"js/polyfill-ie8-30f98ab294.js":[
"polyfill/object-define-property","polyfill/object-keys"],"/js/min_super-0c0b791c0d.js":["common/result_page","common/image_lazy_load","log/webb.min","log/super_all","lib/carditem_log","ps/log","ps/sindex","ps/sug","ps/fpid","start/super_start","page/info","page/scroll"],"/js/super_ext-a0b60bd05d.js":["plugin/mousewheel","weather/setting_refresh","weather/setting_ctrl","weather/setting_view","weather/weather_city"],"/js/resource_error_monitor-ed61c2f0be.js":["page/resource_error_monitor.ts"],
"/js/super_load-86e18c5005.js":["weather/weather_tpl","weather/weather_ctrl","weather/weather_autorefresh","start/skin_start","skin/skin_rewrite","mngr/top_layer","mngr/menu_user","mngr/menu_common","mngr/quit_dialog","mngr/top_menunav_new","common/guide_tip","page/page_exp"],"/js/skin_layer-72c77f7044.js":["skin/skin_init_new","skin/skin_cut_img","skin/skin_model","skin/skin_nav","skin/skin_page","skin/skin_tools","skin/skin_img","skin/skin_control_new","skin/skin_view","skin/skin_new_upload",
"skin/skin_setting","skin/skin_preview","skin/skin_defined","skin/skin_opacity","skin/skin_ajax","skin/skin_extra","skin/skin_random"],"/js/opacity_mod-57b92b76b5.js":["opacity/opacity_tpl","opacity/opacity_action","opacity/opacity_conf"],"/js/min_setting-c3f73c1e26.js":["setting/setting_constructor","setting/mod_drag","setting/setting_action"],"/js/page_setting-f890166cc6.js":["log/super_all","setting/page_setting","setting/tab_msg","start/page_setting_start","common/pop","setting/yaohao",
"msg/const","setting/data_adapter","msg/bind","msg/bind_window","setting/common_setting"],"/js/mancard-b2e42611cf.js":["skeleton/card","skeleton/model","skeleton/card_collection","skeleton/card_showLog","skeleton/card_alsLog","skeleton/presenter","skeleton/card_tab","skeleton/card_refresh","skeleton/toast","setting/card_setting","subscribe/parabola","subscribe/subscribe"],"/js/subscribe-d2630c5b22.js":["subscribe/subscribe"],"/js/s_super_index-3fffae8d60.js":["ps/autohover_input",
...
,"news_new/dialog.css"],"/css/ubase_sync-d600f57804.css?v=md5":["scrollbar_sync.css"],"/css/ubase-89d6b96e41.css?v=md5":["superui/superui.css","superui/dialog.css","superui/tips.css","superui/share.css","superui/scrollbar.css","superui/suggestion.css"],"/css/ubase_sync-d600f57804.css?v=md5":["superui/scrollbar_sync.css"]});window._xman_speed=window._xman_speed||{};F._setContext({base:"lib/sbase"});F.use("lib/mod_evt",function(evt){F._setContextMethod("fire",function(evtName,evtArgs){
return evt.fire(this.svnMod+":"+this.modName,evtName,evtArgs)});F._setContextMethod("listen",function(modName,evtName,handler){var mType=Object.prototype.toString.call(modName);if(mType=="[object String]"){if(modName.indexOf(":")<0){modName=this.svnMod+":"+modName}}else if(mType=="[object Array]"){for(var i=0,len=modName.length;i<len;i++){if(modName[i].indexOf(":")<0){modName[i]=this.svnMod+":"+modName[i]}}}evt.on(modName,evtName,handler)});F._setContextMethod("unListen",function(modName,evtName
,handler){evt.un(this.svnMod+":"+this.modName,evtName,handler)})});F._loadScriptTimeout=15e3;F._useConfig=true;F._firstScreenCSS=F._firstScreenCSS||[];F._firstScreenCSS.push("/css/super_min-6f52ab3317.css");F._firstScreenJS=F._firstScreenJS||[];F._firstScreenJS.push("/js/min_super-0c0b791c0d.js");</script><script id="s_js_mancard_main" data-src="https://pss.bdstatic.com/static/superman/js/mancard-b2e42611cf.js">
    ...
    </script><script type="text/javascript" src="https://pss.bdstatic.com/static/superman/js/min_super-0c0b791c0d.js"></script><script>
(function(){
...
</script><script defer src="//hectorstatic.baidu.com/cd37ed75a9387c5b.js"></script><script src="https://pss.bdstatic.com/static/superman/js/s_super_async-63a29db1f2.js"></script></body></html>